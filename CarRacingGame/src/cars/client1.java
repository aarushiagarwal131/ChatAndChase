...
public class client1 implements ActionListener {
  ...
  client1() {
    ...
    ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("cars/khushbu.jpeg"));
    ...
    JLabel name = new JLabel("Khushbu");
